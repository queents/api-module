...
class ApiGenerator
{
    ...
    public function generateApi()
    {
        ...
        $interfacePath = module_path($this->module) .'/Interfaces/' ;
        $repositoriesPath = module_path($this->module) .'/ApiRepositories/' ;
        $requestValidationPath = module_path($this->module) .'/Http/Requests/Api/' ;
        $resourcePath = module_path($this->module) .'/Http/Resources/Api/' ;
        $resourceFolder = module_path($this->module) .'/Http/Resources/' ;
        ...
        if(!is_dir($requestValidationPath)){

            File::makeDirectory($requestValidationPath);
        ...
        $interfaceController = view('api::templates.interface', [
                "sg" => $sg,
                "sp" => $sp,
                "model" => $model,
                "table" => $this->table,
            ...
            $repositoryController = view('api::templates.repository', [
                "sg" => $sg,
                "sp" => $sp,
                "model" => $model,
                "table" => $this->table,
             ...
             $validationStoreRequestController = view('api::templates.store-validation', [
                 "sg" => $sg,
                 "sp" => $sp,
                 "model" => $model,
                 "table" => $this->table,
             ...
             $validationUpdateRequestController = view('api::templates.update-validation', [
                 "sg" => $sg,
                 "sp" => $sp,
                 "model" => $model,
                 "table" => $this->table,
            ...
            $authController = view('api::templates.api', [
                "sg" => $sg,
                "sp" => $sp,
                "model" => $model,
                "objectName" => lcfirst($model),
                "table" => $this->table,
                "module" => $this->module,
                "cols" => $this->getFileds()
            ]);
            ...
            $authRoutes = view('api::templates.route', [
                "sg" => $sg,
                "sp" => $sp,
                "model" => $model,
                "table" => $this->table,
            ...
            $resourceController = view('api::templates.resource', [
                "sg" => $sg,
                "sp" => $sp,
                "model" => $model,
                "table" => $this->table,
            ...
            File::put($path.$model . 'ApiController.php', $authController);
            File::put($resourcePath.$model.'Resource.php', $resourceController);
            File::put($requestValidationPath.'Store'.$model.'.php', $validationStoreRequestController);
            File::put($requestValidationPath.'Update'.$model.'.php', $validationUpdateRequestController);
            File::put($repositoriesPath.$model . 'Repository.php', $repositoryController);
            File::put($interfacePath.$model . 'RepositoryInterface.php', $interfaceController);
            File::append($routePath.'api.php', $authRoutes);
